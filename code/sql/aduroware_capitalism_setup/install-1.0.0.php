...
$table = $installer->getConnection()
    ...
    ->addColumn('player_id', Varien_Db_Ddl_Table::TYPE_BIGINT, null, array(
        'identity'  => true,
        'nullable'  => false,
        'primary'   => true,
        'unsigned'  => true,
...
$table = $installer->getConnection()
    ...
    ->addColumn('player_transaction_id', Varien_Db_Ddl_Table::TYPE_BIGINT, null, array(
        'identity'  => true,
        'nullable'  => false,
        'primary'   => true,
        ), 'Player Transaction ID')
    ->addColumn('giving_player_id', Varien_Db_Ddl_Table::TYPE_BIGINT, null, array(
        'nullable'  => false,
        'unsigned'  => true,
        ), 'Giving Player ID')
    ->addColumn('receiving_player_id', Varien_Db_Ddl_Table::TYPE_BIGINT, null, array(
        'nullable'  => false,
        'unsigned'  => true,
        ), 'Receiving Player ID')
